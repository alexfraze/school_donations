...
class ApprovalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create approval" do
    assert_difference('Approval.count') do
      post approvals_url, params: { approval: { donation_id: @approval.donation_id, notes: @approval.notes, status: @approval.status, teacher_id: @approval.teacher_id, version: @approval.version } }
    end
  ...
  test "should update approval" do
    patch approval_url(@approval), params: { approval: { donation_id: @approval.donation_id, notes: @approval.notes, status: @approval.status, teacher_id: @approval.teacher_id, version: @approval.version } }
