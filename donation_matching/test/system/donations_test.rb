...
class DonationsTest < ApplicationSystemTestCase
  ...
  test "creating a Donation" do
    ...
    fill_in "Donation date", with: @donation.donation_date
    fill_in "Notes", with: @donation.notes
    fill_in "Parent", with: @donation.parent_id
    fill_in "Status", with: @donation.status
    fill_in "Teacher", with: @donation.teacher_id
    fill_in "Version", with: @donation.version
